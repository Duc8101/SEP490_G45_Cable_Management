...
namespace UnitTests.Tests
{
    ...
    internal class StatisticTests
    {
        ...
        [Test]
        public async Task MaterialFluctuationPerYear_WhenCategoryIsChosen_ReturnsData()
        {
            // Arrange
            int? materialCategoryID = 1;
            int? warehouseID = 1;
        ...
        [Test]
        public async Task CableFluctuationPerYear_WhenCableCategoryIsFound_ReturnsFluctuationData()
        {
            // Arrange
            int? cableCategoryID = 1;
            int? warehouseID = 1;
        ...
        [Test]
        public async Task
        CableCategory_WhenCableCategoriesAreRetrievedSuccessfully_ReturnsListOfCableCategoryStatistics()
        {
            // Arrange
            int? warehouseID = null;
    ...
    new CableCategoryStatistic { CableCategoryId = 2, CableCategoryName = "Category2",
        ...
        [Test]
        public async Task
        MaterialCategory_WhenValidWarehouseID_ReturnsListOfMaterialCategoryStatistics()
        {
            // Arrange
            int? warehouseID = null;
